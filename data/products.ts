...
export const products: Product[] = [
  ...
  product('chicken-wrap', 'Chicken Wrap', 'Sides & Extras', 'Flame-grilled chicken strips wrapped with salad, sauce and a soft tortilla.', '/images/chicken-wrap.png', 8.49, 540),
  product('chicken-pitta', 'Chicken Pitta', 'Sides & Extras', 'Warm pitta packed with grilled chicken, crunchy salad and your chosen sauce.', '/images/chicken-wrap.png', 8.49, 520),
  ...
  product('loaded-fries', 'Loaded Fries', 'Sides & Extras', 'Crisp fries loaded with cheese, sauce and fresh herbs.', '/images/chicken-fries.png', 5.49, 520, true, [sizeOptions], sideAddOns),
  product('fries', 'Fries', 'Sides & Extras', 'Golden fries, salted and served hot.', '/images/chicken-fries.png', 3.49, 360, false, [sizeOptions], sideAddOns),
  product('corn-on-the-cob', 'Corn on the Cob', 'Sides & Extras', 'Sweetcorn grilled and finished with butter and piri seasoning.', '/images/chicken-fries.png', 3.99, 260, false, [], sideAddOns),
  product('side-salad', 'Side Salad', 'Sides & Extras', 'Fresh leaves, cucumber, tomato and house dressing.', '/images/chicken-fries.png', 3.99, 140, false, [], noAddOns),
